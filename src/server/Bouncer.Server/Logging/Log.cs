...
internal static partial class Log
{
	...
	internal static partial void ServerRegistered(this ILogger logger, string name, int id, int totalServers);

	[LoggerMessage(EventId = 2, Level = LogLevel.Debug, Message = "Unregistered server: {name} (Id: {id}) | (Total: {totalServers})")]
	internal static partial void ServerUnregistered(this ILogger logger, string name, int id, int totalServers);
	...
	internal static partial void PlayerJoinServer(this ILogger logger, Guid uniqueId, string serverName, int serverId, int totalPlayers);
	...
	internal static partial void PlayerQuitServer(this ILogger logger, Guid uniqueId, string serverName, int serverId, int totalPlayers);
	...
	internal static partial void PlayerReserveSlotServer(this ILogger logger, Guid uniqueId, string serverName, int serverId, int totalPlayers);
	...
	internal static partial void PlayerReserveSlotTimeoutServer(this ILogger logger, Guid uniqueId, string serverName, int serverId, int totalPlayers);
}
